...
# 音声はコピーではなくAACへ再エンコード。
# 字幕焼き込み処理そのものの切り分けを優先する。
AUDIO_BITRATE = "128k"
...
def check_ffmpeg_features(
    ...
    if "libx264" not in encoder_output:
    ...
    if "subtitles" not in filter_output:
...
# FFmpegログ読み取り
#
# FFmpegのstderr/stdoutを
# 別スレッドで常時読み取る。
#
# これによりPopenのパイプ詰まりを防ぐ。
# =====================================
