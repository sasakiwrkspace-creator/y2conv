...
def create_mp3(
    ...
    print(
        "[DEBUG] MP3 video title:",
        video_title,
        flush=True
    )

    print(
        "[DEBUG] MP3 safe title:",
        safe_title,
        flush=True
    )
    ...
    if (
        ...
        try:
            ...
            print(
                "[DEBUG] MP3元ファイル削除ERROR:",
                repr(e),
                flush=True
            )

    print(
        "[DEBUG] create_mp3 COMPLETE:",
        mp3_file,
        flush=True
    )
...
def create_mp4(
    ...
    if (
        ...
        try:
            ...
            print(
                "[DEBUG] MP4元ファイル削除ERROR:",
                repr(e),
                flush=True
            )

    print(
        "[DEBUG] create_mp4 COMPLETE:",
        mp4_file,
        flush=True
    )
