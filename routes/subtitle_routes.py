...
def register_subtitle_routes(
    ...
    # MP3アップロード
    #
    # MP3をDOWNLOAD_DIRへ保存した直後に
    # Gemini → SRT作成まで一括実行する。
    # ======================================================
