...
def create_mp4(
    ...
    if (
        ...
        and source_file.lower().endswith(
            ".mp4"
        )
    ):
...
def convert_task(
    ...
    try:
        ...
        update_job_status(
            ...
            progress_text="YouTube動画をダウンロードしています..."
        ...
        update_job_status(
            ...
            progress_text="YouTube動画のダウンロードが完了しました。"
