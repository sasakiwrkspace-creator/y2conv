...
"""
        ...
        # ==================================================
        # Gemini Files APIからPartを作成
        #
        # uploaded_fileそのものをcontentsへ渡さず、
        # URIを明示したPartとして渡す。
        # ==================================================

        print(
            ">>> Gemini audio Part 作成開始"
        )
        ...
        # ======================================================
        # Gemini Files API uploaded file削除
        # ======================================================
        ...
        if os.path.exists(
            ...
            try:
                ...
                print(
                    "[GEMINI] TYPE:",
                    type(delete_temp_error).__name__
                )
